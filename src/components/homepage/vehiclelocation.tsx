...
export default function VehicleLocation() {
  return (
    <section className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20 pb-10 md:pb-24 p-5 mt-5 md:mt-24 border-b border-gray-300">
      <div className="flex flex-col gap-5">
        ...
        <span className="font-bold">Efforless</span> Vehicle Location
          ...
          finding. No more{" "}
          <span className="font-bold">wasted time</span>{" "}
          or energy
