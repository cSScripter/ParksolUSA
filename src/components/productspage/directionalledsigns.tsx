...
<div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 justify-items-center items-center">
  {/* First row */}
  <p className="max-w-[440px] pt-5 md:pt-20">
