...
export default function InnovativeSolutions() {
  return (
    <section className="flex flex-col items-center pt-5 md:pb-20 md:gap-5 md:pt-20 px-5 md:px-20 border-b border-gray-300">
      <h2>
        <span className="font-bold">Innovative</span> Solutions
      </h2>

      <div className="flex w-full flex-col md:flex-row items-center justify-center my-5 gap-5 md:gap-10 mt-5 md:my-20">
        <h3 className="md:pt-15 md:pb-15 !font-normal text-center md:text-left">
          We offer <span className="font-bold">more control</span> over your
          spaces - <br className="hidden md:block"/> whether you have a multi-level parking <br className="hidden md:block"/> garage,
          outdoor lot, or{" "}
