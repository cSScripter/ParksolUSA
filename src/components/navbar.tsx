...
export default function NavBar() {
    ...
    const [openSection, setOpenSection] = useState<"products" | "projects" | null>(null);
    ...
    return (
        ...
        <div className="relative group">
            ...
            {/* mobile devices */}
          <button className="block md:hidden" aria-label="Toggle Menu" onClick={() => setIsOpen(!isOpen)}>
        ...
        {/* CHANGE: Added close button in top-right to close the menu */}
         ...
         <span
            ...
            <span className="text-xs text-white ml-2 leading-none">{openSection === "products" ? "▲" : "▼"}</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-white ml-2 leading-none">{openSection === "projects" ? "▲" : "▼"}</span>
          </button>
          {openSection === "projects" && (
            <div className="pl-4 flex flex-col space-y-2 w-full">
              ...
              <a href="#" className="text-base text-center whitespace-nowrap">
                ...
                <a href="#" className="text-lg font-semibold">MEMBER LOGIN</a>
  </div>
)}
        </nav>        
    )
